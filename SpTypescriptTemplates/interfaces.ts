module CSR {
    ...
    export interface IFormRenderContexWithHook extends SPClientTemplates.RenderContext_FieldInForm {
        FormContextHook: IFormContextHook;
    }

    export interface IFormContextHook {
        [fieldName: string]: IFormContextHookField;
    }

    export interface IFormContextHookField {
